...
export default function AdminStaffsPage({ params }: AdminStaffsPageProps) {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        // Fetch staff
        const fetchedStaff = await getAdminStaff(params.clinicId)
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <p className="text-xl text-red-500 mb-4">{error || "Error loading staff"}</p>
          <button 
